...
│  ┌─────────────────────────────────────────────────────┐ │
│  │ getProfile, saveWarehouse, calculateRate,           │ │
│  │ createOrder, getServiceableCouriers, placeOrder,    │ │
│  │ cancelOrder, trackOrder, getOrderDetail,            │ │
│  │ downloadDocument, ...                               │ │
│  └──────────────────────┬──────────────────────────────┘ │
│                         │                                │
│  ┌──────────────────────▼──────────────────────────────┐ │
...
| Component | Role |
|-----------|------|
| **BigshipClient** | Public API. 15 methods for all Bigship endpoints + workflow builder |
...
| **fetch HTTP Client** | HTTP transport with auth header injection via interceptor |
