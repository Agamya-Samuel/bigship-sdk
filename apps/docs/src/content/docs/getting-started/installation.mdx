...
- **Node.js** >= 20.12.0 (CI tests Node 20 and 22)
...
```bash
export BIGSHIP_USERNAME=your-email@example.com
...
import { BigshipConfig, CreateOrderRequestSchema } from '@agamya/bigship-sdk/core';
